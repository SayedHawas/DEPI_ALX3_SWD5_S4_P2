...
namespace MVCDemoLab.Controllers
{
    public class FullCategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CategotyId,Name,Description")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CategotyId,Name,Description")] Category category)
        {
